...
![](/blog/img/raft/raft1.png)

2. 其他服务器同意了，发出OK。  
![](/blog/img/raft/raft2.png)
...
![](/blog/img/raft/raft3.png)

4. 以后通过心跳进行日志复制的通知
![](/blog/img/raft/raft4.png)

5. 如果一旦这个Leader当机崩溃了，那么Follower中有一个成为候选者，发出邀票选举。
![](/blog/img/raft/raft5.png)

6. Follower同意后，其成为Leader，继续承担日志复制等指导工作：
![](/blog/img/raft/raft6.png)
...
#### 日志复制说明
![](/blog/img/raft/raft-replicated-log.png)
...
![](/blog/img/raft/11204152-4fb97264f2d346fea21b1d70df78e7ff.png)
