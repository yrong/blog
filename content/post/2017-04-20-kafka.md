...
![topic-partition](/blog/img/kafka/1-TWNB5FSzfjqGa0g_D8OXtg.png)
...
![segment-offset](/blog/img/kafka/0310022.png)

因为每条消息都被append到该Partition中，属于顺序写磁盘，因此效率非常高（经验证，顺序写磁盘效率比随机写内存还要高，这是Kafka高吞吐率的一个很重要的保证）。

![](/blog/img/kafka/0310023.png)
